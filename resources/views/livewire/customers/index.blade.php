<div>
    ...
    <!-- Customer Modal -->
    <x-modal wire:model="customerModal" title="{{ $editingCustomer ? 'Edit Pelanggan' : 'Tambah Pelanggan Baru' }}" subtitle="Informasi pelanggan & koneksi" separator box-class="w-11/12 max-w-5xl">
