    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            <div class="flex justify-between items-start mb-4">
                ...
                <span class="bg-green-100 text-green-700 text-xs font-semibold px-2 py-1 rounded-full">+100%</span>
            </div>
            <p class="text-slate-500 text-sm font-medium mb-1">Total Pelanggan</p>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            ...
            <p class="text-slate-500 text-sm font-medium mb-1">Pelanggan Aktif</p>
            <h3 class="text-2xl font-bold text-slate-800">{{ number_format($activeUsers) }}</h3>
        </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            <div class="flex justify-between items-start mb-4">
                ...
                <span class="bg-green-100 text-green-700 text-xs font-semibold px-2 py-1 rounded-full">Bulan Ini</span>
            </div>
            <p class="text-slate-500 text-sm font-medium mb-1">Total Pendapatan</p>
            <h3 class="text-2xl font-bold text-slate-800">Rp {{ number_format($monthlyRevenue, 0, ',', '.') }}</h3>
        </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            ...
            <p class="text-slate-500 text-sm font-medium mb-1">Tagihan Belum Bayar</p>
            <h3 class="text-2xl font-bold text-slate-800">{{ number_format($pendingPayments) }}</h3>
        </div>
    </div>

    <!-- Charts Section -->
    <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-100 mt-8">
        ...
        <div class="w-full h-[300px] relative">
            ...
            <div class="flex justify-between mt-2 px-2 text-xs font-medium text-slate-400">
                <span>Mon</span>
                <span>Tue</span>
                <span>Wed</span>
                <span>Thu</span>
