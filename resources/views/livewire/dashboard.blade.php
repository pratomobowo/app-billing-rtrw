<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-all">
            ...
            <p class="text-slate-500 text-xs font-bold uppercase tracking-widest mb-1">Pendapatan Bulan Ini</p>
            ...
            <div class="mt-4 flex items-center gap-2">
                ...
                <span class="text-[10px] text-slate-400 font-medium">Dari invoice terbayar</span>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-all">
            <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <span class="material-symbols-outlined text-6xl text-blue-600">account_balance_wallet</span>
            </div>
            <p class="text-slate-500 text-xs font-bold uppercase tracking-widest mb-1">Estimasi Laba Bersih</p>
            <h3 class="text-2xl font-black {{ $netProfit >= 0 ? 'text-blue-600' : 'text-red-600' }}">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-all">
            <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <span class="material-symbols-outlined text-6xl text-purple-600">lan</span>
            </div>
            <p class="text-slate-500 text-xs font-bold uppercase tracking-widest mb-1">Kesehatan Jaringan</p>
            <h3 class="text-2xl font-black text-slate-800">{{ $onlineRouters }}/{{ $totalRouters }} <span class="text-sm font-bold text-slate-400 tracking-tight">Router Online</span></h3>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-all">
            <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <span class="material-symbols-outlined text-6xl text-orange-600">group</span>
            </div>
            <p class="text-slate-500 text-xs font-bold uppercase tracking-widest mb-1">Status Penagihan</p>
            <h3 class="text-2xl font-black text-slate-800">{{ $pendingPayments }} <span class="text-sm font-bold text-slate-400 tracking-tight">Menunggu Bayar</span></h3>
            <div class="mt-4 flex items-center gap-2">
                <a href="/billing" wire:navigate class="text-[10px] font-bold text-orange-600 hover:underline">Lihat Semua Tagihan &rarr;</a>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div>
                        <h3 class="text-xl font-black text-slate-800">Tren Keuangan 7 Hari</h3>
                        <p class="text-sm text-slate-500 font-medium">Perbandingan Pendapatan vs Pengeluaran</p>
                    </div>
                </div>
        ...
        <div class="space-y-6">
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 h-full">
                <h3 class="text-xl font-black text-slate-800 mb-6">Aktivitas Terakhir</h3>
                <div class="space-y-6">
